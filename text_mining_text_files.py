...
# Gestion des téléchargements NLTK (silencieux si déjà présents)
try:
...
class TextMinerTXT:
    def __init__(self, file_path, ngram_type='unigram', normalization='lemmatization'):
        ...
        # 1. STOPWORDS (Mots vides)
        self.stop_words = set(stopwords.words('english')) # Mettre 'french' si le texte est en français
        
        # Ajout de mots "bruit" spécifiques (À adapter selon votre contenu)
        noise_words = {
        ...
        self.documents = [] # Liste pour stocker les lignes du fichier
...
# 1. Configuration
# Assurez-vous d'avoir un fichier 'patagonia-progress-report-2025.txt' dans le même dossier
miner = TextMinerTXT(
    file_path='patagonia-progress-report-2025.txt',  
