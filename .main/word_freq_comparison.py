...
df1 = pd.read_excel('.patagonia/token_frequencies_patagonia_bigram.xlsx') # Produits
df2 = pd.read_excel('.patagonia/report_frequencies_patagonia_bigram.xlsx') # Rapport
